...
const getApplicationModel = function (deps, opts) {
	...
	const buildEnvVarModel = buildDependentResource(
		{ pine },
		{
	...
	const exports = {
		...
		/**
		 * @namespace balena.models.application.buildEnvVar
		 * @memberof balena.models.application
		 */
		buildEnvVar: addCallbackSupportToModule({
			/**
			 * @summary Get all build environment variables for an application
			 * @name getAllByApplication
			 * @public
			 * @function
			 * @memberof balena.models.application.buildEnvVar
			 *
			 * @param {String|Number} nameOrSlugOrId - application name (string), slug (string) or id (number)
			 * @param {Object} [options={}] - extra pine options to use
			 ...
			 *
			 * @example
			 * balena.models.application.buildEnvVar.getAllByApplication('MyApp').then(function(vars) {
			 * 	console.log(vars);
			 * });
			 *
			 * @example
			 * balena.models.application.buildEnvVar.getAllByApplication(999999).then(function(vars) {
			 * 	console.log(vars);
			 * });
			 *
			 * @example
			 * balena.models.application.buildEnvVar.getAllByApplication('MyApp', function(error, vars) {
			 * 	if (error) throw error;
			 * 	console.log(vars)
			 * });
			 */
			getAllByApplication: buildEnvVarModel.getAllByParent,
			 ...
			 *
			 * @example
			 * balena.models.application.buildEnvVar.get('MyApp', 'VAR').then(function(value) {
			 * 	console.log(value);
			 * });
			 *
			 * @example
			 * balena.models.application.buildEnvVar.get(999999, 'VAR').then(function(value) {
			 * 	console.log(value);
			 * });
			 *
			 * @example
			 * balena.models.application.buildEnvVar.get('MyApp', 'VAR', function(error, value) {
			 * 	if (error) throw error;
			 * 	console.log(value)
			 * });
			 */
			get: buildEnvVarModel.get,
			 ...
			 *
			 * @example
			 * balena.models.application.buildEnvVar.set('MyApp', 'VAR', 'newvalue').then(function() {
			 * 	...
			 * });
			 *
			 * @example
			 * balena.models.application.buildEnvVar.set(999999, 'VAR', 'newvalue').then(function() {
			 * 	...
			 * });
			 *
			 * @example
			 * balena.models.application.buildEnvVar.set('MyApp', 'VAR', 'newvalue', function(error) {
			 * 	if (error) throw error;
			 * 	...
			 * });
			 */
			set: buildEnvVarModel.set,
			 ...
			 *
			 * @example
			 * balena.models.application.buildEnvVar.remove('MyApp', 'VAR').then(function() {
			 * 	...
			 * });
			 *
			 * @example
			 * balena.models.application.buildEnvVar.remove(999999, 'VAR').then(function() {
			 * 	...
			 * });
			 *
			 * @example
			 * balena.models.application.buildEnvVar.remove('MyApp', 'VAR', function(error) {
			 * 	if (error) throw error;
			 * 	...
			 * });
			 */
			remove: buildEnvVarModel.remove,
		}),
